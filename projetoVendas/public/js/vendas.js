function listaVendas(user){
    ...
    $.ajax({
        ...
        statusCode:{
            200: function(data){
                console.log(data.valor_venda[0]+' ola')
                if(data.valor_venda[0] != null){
                    ...
                    html = '<div class="alert alert-danger" role="alert">A consulta não retornou nenhuma ocorrência!</div>'
                }
                $('#box-conteudo').empty()
